# terraform-aws-codecommit-flow-ci/branch
...
| <a name="input_branch"></a> [branch](#input\_branch) | Name of the branch where updates will trigger a build | `string` | `"master"` | no |
